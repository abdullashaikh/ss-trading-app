            ...
            {ledgerFilter === 'custom' && (
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 text-xs w-full min-w-0">
                <input
                  ...
                  className="flex-1 min-w-0 max-w-full px-2 py-1 bg-white border border-gray-300 rounded-lg text-xs"
                />
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-2.5 py-1 bg-brand-700 text-white rounded-lg font-bold shrink-0"
                >
                  Filter
                </button>
              </div>
